...
import dev.skidder.omega.util.math.distance
import dev.skidder.omega.util.math.distanceSq
import dev.skidder.omega.util.math.toRadians
...
data class Vec2d(val x: Double = 0.0, val y: Double = 0.0) {
    ...
    fun length() = dev.skidder.omega.util.math.length(x, y)

    fun lengthSq() = dev.skidder.omega.util.math.lengthSq(x, y)
